        ...
        >
          ...
          <div className="p-4 sm:p-6 border-b border-white/[0.08] bg-slate-900/80 backdrop-blur-xl flex items-start justify-between gap-3">
            <div className="space-y-1 min-w-0 flex-1">
              ...
              <h3 id="tutor-dialog-title" className="text-base sm:text-xl font-bold text-white leading-snug font-heading break-words">
                {topic}
              </h3>
              <p className="text-[11px] sm:text-xs text-slate-400 truncate">{subject?.name}</p>
            </div>
          ...
          {/* Navigation Tabs */}
          <div className="flex border-b border-white/[0.06] bg-slate-950/60 px-4 sm:px-6 pt-2 gap-1 overflow-x-auto" role="tablist">
            <button
              role="tab"
              aria-selected={activeTab === 'guide'}
              onClick={() => setActiveTab('guide')}
              className={`pb-2.5 px-3 sm:px-4 text-[11px] sm:text-xs font-bold transition-all border-b-2 flex items-center gap-1.5 whitespace-nowrap focus-ring ${
                activeTab === 'guide'
